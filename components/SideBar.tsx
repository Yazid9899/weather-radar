    ...
    <div className=" md:max-w-[500px] top-0 left-0 bg-gradient-to-br from-[#394F68] to-[#183B7B] text-white p-10">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <Image
            src={
              `https://www.weatherbit.io/static/img/icons/${getWeatherInfo(data?.current_weather.weathercode).icon}.png`
            }
            alt="icon"
            width={75}
            height={75}
          ...
          <div className="flex items-center justify-between gap-x-10">
            ...
            <p className="text-right font-extralight text-lg whitespace-nowrap">
              {getWeatherInfo(data?.current_weather.weathercode).label}
            </p>
